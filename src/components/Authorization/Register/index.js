...
class RegisterBox extends Component {
  ...
  submitRegister = () => {
    ...
    this.props.handleRegistration({ 'login': username, 'password': password, 'email': email })
  }
      ...
      <div className={style.mainContainer}>
        <div className={style.innerContainer}>
          <div className={style.box}>
            ...
            <button type="button" className={style.loginBtn} onClick={this.submitRegister}>Register</button>
          </div>
        </div>
      </div>
    );
